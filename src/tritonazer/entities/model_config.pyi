...
class TritonModelConfig:
    ...
    @overload
    def remove_inputs(self, inputs: TritonTensorConfig) -> None: ...
    @overload
    def remove_inputs(self, inputs: Iterable[TritonTensorConfig]) -> None: ...
    @overload
    def remove_outputs(self, outputs: TritonTensorConfig) -> None: ...
    @overload
    def remove_outputs(self, outputs: Iterable[TritonTensorConfig]) -> None: ...
